...
#define MY_DEFAULT_IP_ADDR_BYTE1        (169)
#define MY_DEFAULT_IP_ADDR_BYTE2        (254)
#define MY_DEFAULT_IP_ADDR_BYTE3        (254)
#define MY_DEFAULT_IP_ADDR_BYTE4        (254)
...
#if defined(EXPLORER_16) || defined(PICDEMNET2) || defined(PICDEMNET)
	#define USE_LCD
#endif
