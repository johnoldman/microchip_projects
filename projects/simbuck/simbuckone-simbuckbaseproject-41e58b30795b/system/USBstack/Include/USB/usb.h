...
#include "system/USBstack/Include/Compiler.h"

#include "usb_config.h"             // Must be defined by the application

#include "system/USBstack/Include/USB/usb_common.h"         // Common USB library definitions
#include "system/USBstack/Include/USB/usb_ch9.h"            // USB device framework definitions

#if defined( USB_SUPPORT_DEVICE )
    #include "system/USBstack/Include/USB/usb_device.h"     // USB Device abstraction layer interface
#endif
...
#include "system/USBstack/Include/USB/usb_hal.h"            // Hardware Abstraction Layer interface
