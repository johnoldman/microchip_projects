...
//	// Here a comparison to TxCount*8 is done so that we don't 
//	// make a mistake and send too many bytes when a window update
//	// packet could be sitting unprocessed in our RX buffer.
//	if(ps->RemoteWindow < ps->TxCount<<3)
//		return FALSE;
