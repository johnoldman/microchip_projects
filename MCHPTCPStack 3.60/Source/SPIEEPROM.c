...
void XEEInit(unsigned char speed)
{
	...
	EEPROM_SDO_TRIS = 0;	// Set SDO pin as an output
		    ...
		    EEPROM_SPICON1 = 0x13;	// 1:1 primary prescale, 4:1 secondary prescale
		#elif defined(__dsPIC30F__)
		    EEPROM_SPICON1 = 0x17;	// 1:1 primary prescale, 3:1 secondary prescale
		#else //#elif defined(__dsPIC33F__) || defined(__PIC24H__)
		    EEPROM_SPICON1 = 0x03;	// 1:1 primary prescale, 8:1 secondary prescale
		#endif
	    EEPROM_SPICON2 = 0;
...
//		EEPROM_SPICON1 = 0x20;			// SSPEN bit is set, SPI in master mode, FOSC/4, IDLE state is low level
